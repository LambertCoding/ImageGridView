...
import com.lxj.androidktx.core.divider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.vertical()
            ...
            .bindData(list, R.layout.adapter_list) { holder, t, _ ->
                holder.getView<ImageGridView>(R.id.imageGrid).setAdapter(object : ImageGridAdapter<String>(t.list) {
                    override fun onImageItemClick(
                        ...
                        imageDataSet.forEach { urls2.add(it) }
                    ...
                    override fun loadImage(imageView: ImageView, position: Int, url: String) {
                        imageView.load(
                            url = url, isCrossFade = true, placeholder = R.drawable.ic_default_color,
